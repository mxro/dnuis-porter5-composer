// <!-- one.upload https://u1.linnk.it/qc8sbw/usr/apps/textsync/docs/porter5-form-js-0.0.1 -->

(function($) {

	$.initPorter5QuestionForm = function(params) {
		...
		qf.getData = function() {
			return {
				...
				industryStructure : $('input[name=subsitutesRadios]:checked',
						elem).val()
						+ ":"
						+ $('input[name=supplierRadios]:checked', elem).val()
						+ ":"
						+ $('input[name=rivalryRadios]:checked', elem).val()
						+ ":"
						+ $('input[name=buyerRadios]:checked', elem).val()
						+ ":"
						+ $('input[name=entrantsRadios]:checked', elem).val(),
				name : $('.name', elem).val(),
				upi : $('.upi', elem).val()
			};
		}
